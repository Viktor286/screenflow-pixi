...
export declare class Viewport extends PIXI.Container {
  ...
  // Events
  on(event: 'added' | 'removed', fn: (container: PIXI.Container) => void, context?: any): this;
  // Events
  on(event: PIXI.InteractionEventTypes, fn: (event: PIXI.InteractionEvent) => void, context?: any): this;
  on(event: EventType, fn: (viewport: Viewport) => void, context?: any): this;
  on(event: ClickEventType, fn: (data: ClickEventData) => void, context?: any): this;
  on(event: WheelEventType, fn: (data: WheelEventData) => void, context?: any): this;
  on(event: ZoomedEventType, fn: (data: ZoomedEventData) => void, context?: any): this;
  on(event: MovedEventType, fn: (data: MovedEventData) => void, context?: any): this;
